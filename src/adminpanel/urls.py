...
urlpatterns = [
    ...
    path('news_stocks/<str:content_type>', news_stocks, name='news_stocks'),
    ...
    path('table_news_stocks/<str:content_type>', table_news, name='table_news_stocks'),
    ...
    path('delete/<str:content_type>/<int:pk>', table_news_delete, name='delete_news'),
    ...
    path('update/<str:content_type>/<int:pk>', update_news, name='update_news'),
    ...
    path('contact_page/update/<int:pk>', update_contact_page, name='update_contact_page'),
